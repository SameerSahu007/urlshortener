        ...
        <div>
            <form onSubmit={handleSubmit}>
                <div className='flex flex-col my-12'>
                    ...
                    <span className="bg-red-100 text-red-700 p-2 rounded-md text-center
                   lg:w-5/12 md:w-1/2 w-3/4 m-auto ">
                        Please note that the URL is longer because it uses a free domain provided by render.com
                    </span>

                    <label className='text-center text-blue-500 my-4' >Paste your URL here</label>
                    ...
                    <input type="text"
                        ...
                        placeholder="URL"
                        className="border rounded py-2 px-4 focus:outline-none focus:ring-2 focus:ring-blue-500  lg:w-5/12 md:w-1/2 w-3/4 mx-auto justify-left"
                    />
                    <button
                        type="submit"
                        className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 justify-center lg:w-5/12 md:w-1/2 w-3/4 mx-auto my-4 rounded"
                    >
                        Submit
                    </button>
